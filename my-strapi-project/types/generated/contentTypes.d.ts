...
export interface ApiCandidatureCandidature extends Schema.CollectionType {
  ...
  attributes: {
    ...
    motiv: Attribute.Media<'files'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiExpertiseExpertise extends Schema.CollectionType {
  ...
  attributes: {
    NomExpertise: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiOffreOffre extends Schema.CollectionType {
  ...
  attributes: {
    ...
    MiniResume: Attribute.Text & Attribute.Required;
    Resume: Attribute.Text & Attribute.Required;
    InfosComplementaire: Attribute.Text;
...
export interface ApiReferencesReferences extends Schema.CollectionType {
  ...
  attributes: {
    NomChantier: Attribute.String & Attribute.Required & Attribute.Unique;
    LocalisationChantier: Attribute.String &
      Attribute.Required &
      Attribute.Unique;
    SousTitre: Attribute.String;
    Description: Attribute.Text;
    MontantChantier: Attribute.BigInteger;
    MaitreOuvrage: Attribute.String;
    Architecte: Attribute.String;
    BureauEtude: Attribute.String;
    DateLivraison: Attribute.Date;
    DureeChantier: Attribute.Integer;
    ...
    secteur: Attribute.Relation<
      ...
      'api::secteur.secteur'
    >;
    ImagePrincipale: Attribute.Media<'images'> & Attribute.Required;
    ImagesSecondaires: Attribute.Media<'images', true>;
...
export interface ApiSecteurSecteur extends Schema.CollectionType {
  ...
  attributes: {
    NomSecteur: Attribute.String & Attribute.Required & Attribute.Unique;
    references: Attribute.Relation<
      'api::secteur.secteur',
      'oneToMany',
      'api::references.references'
    >;
    Design: Attribute.Media<'images'> & Attribute.Required;
    Description: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiTemoignageTemoignage extends Schema.CollectionType {
  ...
  attributes: {
    PhotoProfil: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::references.references': ApiReferencesReferences;
